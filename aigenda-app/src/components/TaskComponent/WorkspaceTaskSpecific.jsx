...
const WorkspaceTaskSpecific = ()=>{
    ...
    useEffect(() => {
        if (!task && resolvedWorkspaceId && resolvedSpaceId) {
    ...
    return(
      ...
      <div className="task-content-grid">
        ...
        <div className="task-sidebar-card">
          ...
          {isUpdateOpen && <UpdateTask updateTask={isUpdateOpen} setUpdateTask={setIsUpdateOpen}/>}
          {isDeleteOpen && <DeleteTask setDeleteTask={setIsDeleteOpen} taskId={task.id} workspaceId={resolvedWorkspaceId} spaceId={resolvedSpaceId}/>}
        </div>
    )
};
