...
const TaskStatusDetails = ({setOpenTSD})=>{
    const pieData = [
  ...
  const stats = [
    { isTotal: true, value: 250, label: "Total Tasks" },
    { value: 200, max: 250, color: "#3b82f6", trackColor: "#bfdbfe", label: "Completed" },
    { value: 20, max: 250, color: "#60a5fa", trackColor: "#e0e7ff", label: "In Progress" },
    { value: 30, max: 250, color: "#ef4444", trackColor: "#fecaca", label: "Pending" }
  ];
    return(
