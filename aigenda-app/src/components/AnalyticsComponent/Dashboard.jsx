...
const pieData = [
  ...
  { name: 'To Do', value: 15, color: '#e5e7eb' },
  { name: 'Over Due', value: 5, color: '#ef4444' },
];
    ...
    <div className="app-container">
      ...
      <div className="left-column">
        ...
        <div className="card chart-card">
          <div className="chart-header">
            <span>Productivity is improving by 12%</span>
      ...
      <div className="right-column">
        ...
        <div className="card alert-card card-border-purple-light">
          ...
          <p>
            You have <em>3 over due tasks</em>, you can start a focus session to estimate your productivity
          </p>
        </div>
      ...
      {openCompletedTasksDetails && <CompletedTasksDetails setOpenCTD={setOpenCompletedTasksDetails}/>}
      {openFocusSessionDetails && <FocusSessionDetails setOpenFSD={setOpenFocusSessionDetails}/>}
      {openTaskStatusDetails && <TaskStatusDetails setOpenTSD={setOpenTaskStatusDetails}/>}
    </div>
  );
};
