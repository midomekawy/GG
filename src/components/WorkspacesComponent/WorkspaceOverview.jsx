              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    cursor: "pointer",
                    backgroundColor: taskView === "list" ? "#ffffff" : "transparent",
                    color: taskView === "list" ? "#5f17bf" : "#64748b",
                    fontWeight: "500",
                    fontSize: "13px",
                    boxShadow: taskView === "list" ? "0 1px 2px rgba(0,0,0,0.05)" : "none",
                  }}
                >
                  <ListFilter size={14} />
                  List
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    cursor: "pointer",
                    backgroundColor: taskView === "board" ? "#ffffff" : "transparent",
                    color: taskView === "board" ? "#5f17bf" : "#64748b",
                    fontWeight: "500",
                    fontSize: "13px",
                    boxShadow: taskView === "board" ? "0 1px 2px rgba(0,0,0,0.05)" : "none",
                  }}
                >
                  <Columns3 size={14} />
                  Board
            ...
            >
              {priorityTasks.map((t, idx) => {
                ...
                return (
                  ...
                  >
                    <p style={{ marginBottom: "1px", fontWeight: "500" }}>
                      {taskTitle(t)}
                    </p>
                    <div
                      style={{
